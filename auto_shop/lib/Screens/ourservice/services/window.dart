...
import 'package:auto_shop/Screens/ourservice/services/paint.dart';
...
class _WindowState extends State<Window> {
  ...
  Query dbRef = FirebaseDatabase.instance.ref().child('shops').orderByChild('category').equalTo('WindSheild and Windows');
