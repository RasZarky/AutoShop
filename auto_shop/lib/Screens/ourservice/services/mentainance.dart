...
class Mentainance extends StatefulWidget {
  const Mentainance({Key? key}) : super(key: key);

  @override
  State<Mentainance> createState() => _MentainanceState();
}

class _MentainanceState extends State<Mentainance> {

  Query dbRef = FirebaseDatabase.instance.ref().child('shops').orderByChild('category').equalTo('General Maintenance');
  bool isLoading = true;
